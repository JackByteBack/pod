!function t(e, i, n) {
        ...
        p._getStickyEnabled = function () {
            ...
            p._initializeMenu = function () {
                ...
                (this._debounce = function (t) {
                    ...
                    ,
                    s && r && a) && (this.menu = new h(s, r, a, this.tray, o, this._selectors.menuCtaClickClassName),
                        ...
                        window.addEventListener(c, this._closeMenu),
                        this._viewports.on("change:orientation", this._closeMenu),
            ...
            p._onScroll = function (t) {
                ...
                this.tray && (this.menu.isOpen() && (null === this._menuCollapseOnScroll && (this._menuCollapseOnScroll = this.tray.offsetHeight >= this.tray.scrollHeight),
                    this._menuCollapseOnScroll ? this._closeMenu() : (e = t.target,
                        n(e, d) && s(e, this._selectors.traySelector, !0) || (t.preventDefault(),
    ...
    26: [function (t, e, i) {
        ...
        r.prototype.constructor = r,
            o.update = function (t) {
                var e, i = this.isOpen(), n = t && t instanceof KeyboardEvent, s = t && t instanceof MouseEvent, r = t && !n && !s;
                i !== this._lastOpen && (this.trigger(i ? "open" : "close"),
                    this.el.setAttribute("aria-expanded", i ? "true" : "false"),
                    i ? (this.chevron.expand(),
                        e = this.anchorClose) : (this.chevron.collapse(),
                            e = this.anchorOpen),
                    t && (e.focus(),
                        r && (e.classList.add(this.clickClass),
    ...
    29: [function (t, e, i) {
        ...
        o.prototype.constructor = o,
            h._featureDetection = function () {
                var t = a().browser.edge
                    , e = "css-sticky";
    ...
    39: [function (t, e, i) {
        "use strict";
        var n, s = t(22).EventEmitterMicro, r = t(45), a = t(44);
        function o(t) {
            t = t || {},
                s.call(this),
                this.id = a.getNewID(),
    ...
    48: [function (t, e, i) {
        "use strict";
        var n, s = t(3)(t(6)), r = "undefined" != typeof window ? window : {}, a = "SharedInstance", o = r.AC, c = (n = {},
        {
            get: function (t, e) {
                var i = null;
    ...
    56: [function (t, e, i) {
        ...
        e.exports = function (t, e) {
            ...
            var i = function i() {
                var n = arguments
                    , s = e.apply(this, n);
                return s in i.cache || (i.cache[s] = t.apply(this, n)),
                    i.cache[s]
            };
            return i.cache = {},
                i
    ...
    61: [function (t, e, i) {
        ...
        function a(t, e, i) {
            for (var n, s, a = t.length, o = 0; o < a; o++)
                if ("function" == typeof t[o].test ? !0 === t[o].test(i) && (n = t[o].name) : i.ua.indexOf(t[o].userAgent) > -1 && (n = t[o].name),
                    n) {
                    if (e[n] = !0,
                        "string" == typeof (s = r(t[o], i.ua))) {
                        var c = s.split(".");
                        e.version.string = s,
        ...
        e.exports = function (t) {
            var e = {}
                , i = n(s);
            return e.browser = a(s.browser, i.browser, t),
                e.os = a(s.os, i.os, t),
                e
        }
    }
        ...
        Object.defineProperty(b, "id", {
            ...
            b._onViewportChange = function () {
                this._resizing || (this._resizing = !0,
                    s.update(this._onViewportChangeUpdate))
            }
            ,
