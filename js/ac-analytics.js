 ...
 */
        ...
        class h extends p {
            ...
            _initializeSwipeListener() {
                ...
                const e = this.isTouch ? "touchstart" : "mousedown"
                    ...
                    , o = e => {
                        this.isScrolling || (this.swipeStart = !0,
                            this.scrollContainer.removeEventListener(t, s),
                            this.scrollContainer.addEventListener(t, s))
                    }
                    , a = () => {
                        this.swipeStart = !1,
                            this.scrollContainer.removeEventListener(t, s)
            ...
            _initializeArrowKeyListener() {
                window.addEventListener("keydown", (e => {
                    if ("ArrowLeft" === e.key || "ArrowRight" === e.key) {
                        if (this.cleanupSwipeScrollListener && this.cleanupSwipeScrollListener(),
                            !this.isInView || !this._isGalleryVisible())
                            return;
    ...
    447: [function (e, t, n) {
        t.exports = Object.freeze("2.29.1")
    }
        , {}],
